...
pub fn init() {
    ...
    crate::intrs::idt::set_handler(0, 0, dpl, generic::div0_handler, false, true);
    crate::intrs::idt::set_handler(1, 0, dpl, generic::debug_handler, false, true);
    crate::intrs::idt::set_handler(2, 0, dpl, generic::nmi_handler, false, false);
    crate::intrs::idt::set_handler(3, 0, dpl, generic::breakpoint_handler, false, true);
    crate::intrs::idt::set_handler(4, 0, dpl, generic::overflow_handler, false, true);
    crate::intrs::idt::set_handler(5, 0, dpl, generic::bound_range_handler, false, true);
    crate::intrs::idt::set_handler(6, 0, dpl, generic::invalid_opcode_handler, false, true);
    crate::intrs::idt::set_handler(7, 0, dpl, generic::dev_unavailable_handler, false, true);
    ...
    crate::intrs::idt::set_handler(12, 0, dpl, gdt::stack_exc_handler, false, true);
    crate::intrs::idt::set_handler(13, 0, dpl, gdt::general_prot_fault_handler, false, true);
    crate::intrs::idt::set_handler(14, 0, dpl, page_fault::handler, false, true);
    crate::intrs::idt::set_handler(15, 0, dpl, generic::reserved_handler, false, false);
    crate::intrs::idt::set_handler(16, 0, dpl, generic::x87_fp_handler, false, true);
    crate::intrs::idt::set_handler(17, 0, dpl, generic::align_chk_handler, false, true);
    crate::intrs::idt::set_handler(18, 0, dpl, generic::machine_chk_handler, false, false);
    crate::intrs::idt::set_handler(19, 0, dpl, generic::simd_fp_handler, false, true);
    ...
    crate::intrs::idt::set_handler(28, 0, dpl, generic::hv_injection_handler, false, true);
    crate::intrs::idt::set_handler(29, 0, dpl, generic::vmm_com_handler, false, true);
    crate::intrs::idt::set_handler(30, 0, dpl, generic::security_handler, false, true);
