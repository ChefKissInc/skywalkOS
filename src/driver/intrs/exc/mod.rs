...
pub fn init() {
    ...
    super::idt::set_handler(10, 0, generic::overflow_handler, false, false);
    super::idt::set_handler(11, 0, gdt::invalid_tss_handler, false, false);
    super::idt::set_handler(12, 0, gdt::segment_not_present_handler, false, false);
    super::idt::set_handler(13, 0, gdt::stack_exc_handler, false, false);
    super::idt::set_handler(14, 0, gdt::general_prot_fault_handler, false, false);
    super::idt::set_handler(15, 0, page_fault::handler, false, false);
    super::idt::set_handler(16, 0, generic::reserved_handler, false, false);
    super::idt::set_handler(17, 0, generic::x87_fp_handler, false, false);
    super::idt::set_handler(18, 0, generic::align_chk_handler, false, false);
    super::idt::set_handler(19, 0, generic::machine_chk_handler, false, false);
    super::idt::set_handler(20, 0, generic::simd_fp_handler, false, false);
    super::idt::set_handler(21, 0, generic::reserved_handler, false, false);
    super::idt::set_handler(22, 0, generic::x87_fp_handler, false, false);
    for i in 23..28 {
